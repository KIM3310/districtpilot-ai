# Service Growth Model - districtpilot-ai
...
| Field | Decision |
|---|---|
| Service type | Civic operations forecasting |
| Primary reader or buyer | Public-sector or civic operations teams validating forecasting workflows. |
| Wedge | Public dataset prototype and procurement-friendly security review. |
