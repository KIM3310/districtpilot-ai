# Service Architecture - districtpilot-ai
...
- **Lane:** Civic operations forecasting
- **Primary buyer:** Public-sector or civic operations teams validating forecasting workflows
- **First motion:** Public dataset prototype and procurement-friendly security review

## Recommended Architecture

Static demo, API/container for forecast jobs, Postgres for scenario metadata, object storage for public-data snapshots.
...
- DATABASE_URL
- storage credentials
- forecast provider keys if used
...
- public data first
- procurement-friendly security notes
- no policy automation claims
