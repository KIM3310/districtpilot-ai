# Revenue Architecture - districtpilot-ai
...
| Layer | Decision |
| --- | --- |
| Target buyer / user | municipal team, civic data group, grant operator, or public-sector consultant |
| Productized offer | district operations planning and public API readiness explorer |
| First paid SKU | paid readiness report, data connector pack, and private planning workspace |
| Free lead magnet | public static district planning demo with architecture notes |
| Paid expansion | fixed-price readiness assessment and monthly workspace for scenario planning |
| Data / workflow moat | public API catalog, district scenario templates, data quality findings, and planning assumptions |
| Private inquiry | https://kim3310-doeon-kim-portfolio.pages.dev/?offer=districtpilot-ai&inquiry=private-ai-readiness-sprint#private-inquiry |
...
| Repo-specific launch path | GitHub Pages or Cloudflare Pages front, Workers API, D1/KV public metadata, R2 report exports, OpenRouter/Groq for narrative summaries |
...
2. Route confidential and commercial requests through the [central Cloudflare D1 private inquiry](https://kim3310-doeon-kim-portfolio.pages.dev/?offer=districtpilot-ai&inquiry=private-ai-readiness-sprint#private-inquiry); keep public GitHub issues limited to non-confidential product discussion.
