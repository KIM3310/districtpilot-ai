# Commercial Offer - DistrictPilot AI
...
| Forecast review workshop | $20k-$60k pilot | Create procurement-friendly one-pager |
...
- Lead with the buyer's workflow: "For Local governments, field-service planners, civic analytics teams, and district operators, the hard part is often moving from proof to operating handoff without creating new risk."
- Use the proof hook: "I can show the first proof artifact (Judge fast path works), then map it to one workflow you already own."
- Use the metric hook: "The first scorecard can focus on Forecast error, not a vague AI transformation claim."
