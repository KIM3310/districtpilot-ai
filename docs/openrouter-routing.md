...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `google/gemini-3.5-flash` | District planning narrative, scenario explanations, and policy memo drafts. |
...
OPENROUTER_HTTP_REFERER=https://districtpilot-ai.pages.dev
OPENROUTER_APP_TITLE=districtpilot-ai
```
